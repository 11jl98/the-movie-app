...
const DrawerList = [
  ...
  { icon: "account-search", label: "Pesquisa", navigateTo: "Pesquisa" },
  { icon: "account-multiple", label: "Profile", navigateTo: "Profile" },
];

const DrawerLayout = ({ icon, label, navigateTo }: drawerPropsInteface) => {
...
function DrawerContent(props: any) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#0f9690" }}>
